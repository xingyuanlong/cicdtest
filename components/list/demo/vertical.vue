...
<template>
  <pf-list item-layout="vertical" size="large" :pagination="pagination" :data-source="listData">
    <template #footer>
      <div>
        <b>ant design vue</b>
        footer part
...
for (let i = 0; i < 23; i++) {
  listData.push({
    ...
    description:
      'pf-ui-vuen, a design language for background applications, is refined by Ant UED Team.',
    content:
